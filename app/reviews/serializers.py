...
class StudentReviewBaseSerializer(serializers.ModelSerializer):
...
class StudentReviewDetailSerializer(StudentReviewBaseSerializer):
    pass


class StudentReviewListSerializer(StudentReviewBaseSerializer):
